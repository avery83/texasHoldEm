...
<div class="container-fluid">
    <h3 style="color:white;">Set up your game</h3>
</div>
<div>
    <form id="signUpForm" role="form" data-toggle="validator" class="form-horizontal"
          action="${pageContext.request.contextPath}/createGame"
          method="post">

        <div class="form-group">
            <label class="control-label col-sm-2" for="numberOfPlayers" style="color:white;">Number Of Players</label>
            <div class="col-sm-4">

                <input type="number" class="form-control" id="numberOfPlayers"
                       name="numberOfPlayers" min="2" max="10" step="1"
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="startingChips" style="color:white;">Starting Chips
            </label>
            <div class="col-sm-4">
