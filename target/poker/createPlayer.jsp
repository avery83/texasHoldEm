...
<div>
    <form id="signUpForm" role="form" data-toggle="validator" class="form-horizontal"
          action="${pageContext.request.contextPath}/createPlayer"
          method="post">

        <div class="form-group">
            <label class="control-label col-sm-2" for="userName" style="color:white;">User
                Name</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="password" style="color:white;">Password
            </label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2"
                   for="confirmPassword" style="color:white;">Retype
                Password</label>
            <div class="col-sm-4">
